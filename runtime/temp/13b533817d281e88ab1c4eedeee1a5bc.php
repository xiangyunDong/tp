<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"G:\phpStudy\WWW\twothink\public/../application/admin/view/default/ticket\index.html";i:1552640493;s:82:"G:\phpStudy\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
			...
			<tbody>
				<?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ticket): $mod = ($i % 2 );++$i;?>
					<tr>
                        ...
                        <td><span><?php echo time_format($ticket['create_time']); ?></span></td>
						<td>
